        ...
        <div className="min-w-0 flex-1">
          <div className="flex flex-wrap items-start justify-between gap-2">
            <div>
              ...
              <p className="mt-1 text-sm font-semibold text-emerald-900">{ratingLine}</p>
            </div>
            <p className="rounded-full bg-emerald-950 px-3 py-1 text-sm font-semibold text-white">{new Intl.NumberFormat("fr-GN").format(provider.hourly_rate_gnf)} {t.perHour}</p>
          </div>
